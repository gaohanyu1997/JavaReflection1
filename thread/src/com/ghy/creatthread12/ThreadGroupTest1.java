...
public class ThreadGroupTest1 {
    public static void main(String[] args) {
        ...
        //2）定义线程粗,如果不指定所属线程组,则自动归属当前线程所属的线程组中
        ThreadGroup group1 = new ThreadGroup("group1");
        System.out.println(group1);
        //3)定义线程组,同时指定父线程组
        ThreadGroup group2 = new ThreadGroup(mainGroup,"group2");
        //现在group1与group1都是mainGroup线程组中的子线程组,调用线程组的getParent()返回父线程组
        ...
        //在main线程中创建来t1线程,称main线程为父线程,t1线程为子线程,
        ...
        System.out.println(t2); //Thread[t2,5,group1]   线程名称,优先级,线程组名
        System.out.println(t3); //Thread[t3,5,group2]   线程名称,优先级,线程组名
    }
}
