...
public class ThreadPoolTest8 {
    ...
    private static class CountTask extends RecursiveTask<Long>{
        //定义数据规模的阈值,允许计算10000个数内的和,超过阈值的数列就需要分解
        private static final int THRESHOLD = 10000;
        private static final int TASKNUM = 100; //定义每次把任务分解为100个小任务
        ...
        protected Long compute() {
            ...
            if(end - start < THRESHOLD){
                ...
                //start = 0,end = 200000,step = 2000,如果计算{0,200000}范围内的和,
                //把该范围的数列分解为100个小任务，每个任务计算2000即可
                //注意,如果任务划分的层次很深,即THRESHOLD阈值太小,每个任务的计算量很小,层次划分就会很深，可能出现两种情况
                //一：是系统内的线程数量会越积越多,导致性能下降严重
